...
4. On trade close → appended to `trade_ledger_2026.csv` → auto-synced to `dashboard.db` trades table
5. Alerts → Telegram via `services/telegram_bot.py` in real-time
